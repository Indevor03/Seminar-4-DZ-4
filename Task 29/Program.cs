...
void СheckNumber2(int series)
{
    ...
    {
        Console.WriteLine($"Ошибка ввода  символа. Ввести цифры.");
...
// Вывод случйных восьми цифр в массив

Console.WriteLine($"Ряд 8 случайных чисел с выводом в массив:");
